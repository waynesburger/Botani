...
import { ToastController, AlertController /*, IonicPage*/ } from '@ionic/angular';
...
export class BotaniMap {
     ...
     * @param toastCtrl 
     */
    constructor(public rout: Router, public geolocation: Geolocation, private TreeFactory: TreeFactory,
